  ...
  return (
    <main className="min-h-screen flex items-center justify-center" style={{ background: "#060d1f" }}>
      ...
      >
        ...
        <div className="rounded-xl p-4 mb-6 flex items-center justify-between gap-3"
          style={{
            background: "rgba(0,212,255,0.06)",
            border: "1px solid rgba(0,212,255,0.2)"
          }}>
          <div className="text-left">
            <p className="text-xs mb-1" style={{ color: "rgba(148,163,184,0.7)" }}>
              Your RetailIQ User ID
            </p>
            <p className="text-xl font-bold font-mono" style={{ color: "#00d4ff" }}>
              {displayId}
            </p>
          </div>
        ...
        {copied && (
          <p className="text-xs mb-4" style={{ color: "#00d4ff" }}>
            Copied to clipboard!
          </p>
        )}

        <div className="flex items-center gap-2 mb-6 text-xs rounded-lg px-3 py-2.5"
          style={{
